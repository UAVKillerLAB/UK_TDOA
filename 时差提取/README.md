...
-将代码修改为PHAT加权方法＜/br＞
-理由：＜/br＞
-原来的RHAT加权在低信噪比之下，锐化图像峰值的效果较差＜/br＞
-而经过实验后发现，PHAT加权方法能在低信噪比的情况下保持优秀的锐化效果＜/br＞
-2020年3月20日＜/br＞
-新增加内插法，以提高精度＜/br＞
-2020年4月9日＜/br＞
-上传有内插法和无内插法的python程序＜/br＞
-经发现，代码的误差原因系扫描频率的问题，扫描频率过于小，使得精度不够，目前的代码里，使用的是5*10^6级别的扫描频率＜/br＞
-另外，由于内插法计算量大，运行内插法代码的时候，所耗时间较长，建议调试代码的时候用软件自带的调试按钮操作＜/br＞
-经测试，内插法平均运行时间在5分钟左右＜/br＞
